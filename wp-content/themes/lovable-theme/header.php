...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site">
        ...
        <header class="w-full">
            ...
            if ($header_banner): ?>
                <img src="<?php echo esc_url($header_banner); ?>"
                    alt="<?php esc_attr_e('Széchenyi Terv Plusz és EU logók banner', 'lovable-theme'); ?>"
                    class="w-full h-auto" />
            <?php else: ?>
                <!-- EU Funding Banner - matches template design -->
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/b7c2651a-4931-45d8-8290-923fa486cbef.png"
                    alt="<?php esc_attr_e('Széchenyi Terv Plusz és EU logók banner', 'lovable-theme'); ?>"
                    class="w-full h-auto" />
            <?php endif; ?>
        </header>
        ...
        <?php if (is_front_page()): ?>
            ...
            ?>
            <section style="background-image: url('<?php echo esc_url($bg_image_url); ?>')"
                class="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-blue-header relative">
        ...
        class Lovable_Walker_Nav_Menu extends Walker_Nav_Menu
        {
            ...
            function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
            {
                ...
                $attributes .= ' class="py-4 px-6 text-white hover:text-blue-200 hover:bg-blue-700 transition-colors font-medium"';
        ...
        function lovable_fallback_menu()
        {
            ...
            foreach ($menu_items as $item) {
                echo '<a href="' . esc_url($item['url']) . '" class="py-4 px-6 text-gray-700 hover:text-blue-600 hover:bg-gray-50 transition-colors font-medium no-underline">';
